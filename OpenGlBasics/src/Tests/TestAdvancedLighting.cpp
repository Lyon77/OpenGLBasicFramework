...
namespace test {
	...
	void TestAdvancedLighting::MouseCallback(GLFWwindow* window, double xpos, double ypos)
	{
	...
	void TestAdvancedLighting::ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
	{
	...
	void TestAdvancedLighting::ProcessInput(GLFWwindow* window, float deltaTime)
	{
	...
	{
		ImGui::TextWrapped("Welcome to the Advanced Lighting Test Enviroment. This uses Blinn-Phong lighting. Use WASD to move around and QE to zoom in and out. There are more setting options below.");
