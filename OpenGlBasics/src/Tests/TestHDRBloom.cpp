...
namespace test {
	...
	void TestHDRBloom::OnRender()
	{
		...
		// Load the box
		{
			...
			m_Shader->SetUniform1i("u_NumPointLights", 2);
			...
			m_Shader->SetUniform3f("u_PointLight[1].position", m_LampPos.x + 3.0f, m_LampPos.y, m_LampPos.z);
			m_Shader->SetUniform3f("u_PointLight[1].ambient", m_LampAmbient.x, m_LampAmbient.y, m_LampAmbient.z);
			m_Shader->SetUniform3f("u_PointLight[1].diffuse", m_LampDiffuse.x, m_LampDiffuse.y, m_LampDiffuse.z);
			m_Shader->SetUniform3f("u_PointLight[1].specular", m_LampSpecular.x, m_LampSpecular.y, m_LampSpecular.z);
